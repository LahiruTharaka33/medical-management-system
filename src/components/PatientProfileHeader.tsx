...
export default function PatientProfileHeader({ patient }: { patient: PatientData }) {
    return (
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm ring-1 ring-slate-200 dark:ring-slate-700 p-4 lg:p-6 mb-8">
            <div className="flex flex-col md:flex-row items-center gap-6">
                {/* Avatar */}
                <div className="h-16 w-16 lg:h-24 lg:w-24 rounded-full bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center shadow-lg ring-4 ring-teal-50 dark:ring-teal-900/50">
